...
export default function Herosec() {
  ...
  return (
    <div className="w-full lg:w-[90%] mx-auto relative mt-20">
      <div className="lg:hidden w-[90%] h-full mx-auto">
    <Search_component /> {/* Hide search on large screens */}
    </div>
    <div className="rounded-lg mt-3 overflow-hidden relative"
